                      ...
                      <td class="style17"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="6"><img src="images/c_bg1.jpg" width="6" height="29" /></td>
                                <td class="style11 style="font-family:Times New Roman">BAI POST <!--img src="images/new.gif" width="33" height="16" align="absmiddle" /--></td>
                        </tr>
                        </table></td>
                    </tr>
                    <tr><td align="center" style="padding:20px"><img width="90%" src="http://rsd.gsfc.nasa.gov/goes/pub/goes/1004261730G15color_small.jpg" /></td>
                      <!--td class="style20">
					  	<?php $row = 5;
$col = 2;
                  ...
                  <td class="style4"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td class="style17"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td width="6"><img src="images/c_bg1.jpg" width="6" height="29" /></td>
                                <td class="style11">TIN TỨC &amp; SAN PHAM <!--img src="images/new.gif" width="33" height="16" align="absmiddle" /--></td>
                        </tr>
                        </table></td>
                    </tr>
                    <tr><td align="center" style="padding:20px"><img width="90%" src="http://rsd.gsfc.nasa.gov/goes/pub/goes/1004261730G15color_small.jpg" /></td>
