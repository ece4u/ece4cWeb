...
error_reporting(E_ALL); @ini_set('display_errors', true);
	$pages = array(
		'0'	=> array('id' => '1', 'alias' => 'Trang-chủ', 'file' => '1.php'),
		'1'	=> array('id' => '2', 'alias' => 'Huấn-luyện-là-gì', 'file' => '2.php'),
		'2'	=> array('id' => '4', 'alias' => 'Câu-chuyện-thành-công', 'file' => '4.php'),
		'3'	=> array('id' => '3', 'alias' => 'Liên-hệ', 'file' => '3.php')
	);
	$forms = array(
		'3'	=> array(
			'1856673c' => Array( 'email' => '', 'subject' => 'Inquiry from the web page', 'sentMessage' => 'Mẫu thư đã được gửi', 'smtpEnable' => false, 'smtpHost' => null, 'smtpPort' => null, 'smtpEncryption' => null, 'smtpUsername' => null, 'smtpPassword' => null, 'fields' => array( array( 'fidx' => '0', 'name' => 'Tên', 'type' => 'input', 'options' => '' ), array( 'fidx' => '1', 'name' => 'Email', 'type' => 'input', 'options' => '' ), array( 'fidx' => '2', 'name' => 'Thư', 'type' => 'textarea', 'options' => '' ) ) )
		)
	);
	$langs = null;
	$def_lang = null;
	...
	$base_url = '/';
	$user_domain = 'hocdientu.tk';
	$show_comments = false;
	include dirname(__FILE__).'/functions.inc.php';
	$home_page = '1';
	list($page_id, $lang) = parse_uri();
	$user_key = "ZvWNgrtBIIfYRnT4";
	$user_hash = "993e671468e7718f";
	$comment_callback = "http://uk.zyro.com/vi-VN/comment_callback/";
	$preview = false;
	$mod_rewrite = true;
